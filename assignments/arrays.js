...
let inv = inventory.find(item => item.id === 33); //Alternative: Helps when the ids are not arranged serially or when we are dealing with large array.

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = inventory.length - 1;
const car = inventory[lastCar]
console.log(car.car_make, car.car_model);
...
//Alternative simplified method using arrow function
BMWAndAudi = inventory.filter(val => val.car_make === 'BMW' || val.car_make === 'Audi')